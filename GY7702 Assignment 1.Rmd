...
This document is my submission for Assignment 1 for R for Data Science (GY7702). It was created using RMarkdown in RStudio and knitted into a pdf. 
You can find more information in my **[Github repository](https://github.com/benc97/RfDS-coursework-1)**.
...
`covid19_cases_20200301_20201017.csv` contains information [**from the UK Government**](https://coronavirus.data.gov.uk/details/cases) on the number of new and cumulative cases of covid-19 from 1st March to 17th October in the UK.
...
`lad19_population.csv` contains a table with the population of every local authority district mentioned in `covid19_cases_20200301_20201017.csv`.
